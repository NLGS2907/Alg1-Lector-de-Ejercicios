...
DiccionarioEjercicio: TypeAlias = dict[str, list[str] | dict[str, list[str]]]
DiccionarioUnidad: TypeAlias = dict[str, str | DiccionarioEjercicio]
DiccionarioGuia: TypeAlias = dict[str, str | DiccionarioUnidad]
